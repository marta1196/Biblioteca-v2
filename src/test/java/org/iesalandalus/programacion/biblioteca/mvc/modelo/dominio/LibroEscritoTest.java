...
public class LibroEscritoTest {
	...
	private static LibroEscrito primerLibro;
	private static LibroEscrito segundoLibro;
	
	@BeforeClass
	public static void inicializaAtributos() {
		primerLibro = new LibroEscrito(TITULO1, AUTOR1, NUM_PAGINAS1);
		segundoLibro = new LibroEscrito(TITULO2, AUTOR2, NUM_PAGINAS2);
	}
	...
	public void constructorTituloNoValidoAutorValidoNumPaginasValidoLanzaExcepcion() {
		...
		try {
			libro = new LibroEscrito("", AUTOR1, NUM_PAGINAS1);
			fail(TITULO_INCORRECTO);
	...
	public void constructorTituloValidoAutorNoValidoNumPaginasValidoLanzaExcepcion() {
		...
		try {
			libro = new LibroEscrito(TITULO2, "", NUM_PAGINAS2);
			fail(AUTOR_INCORRECTO);
		} catch (IllegalArgumentException e) {
	...
	public void constructorLibroValidoCopiaLibroCorrectamente() {
		LibroEscrito libro1 = new LibroEscrito(TITULO1, AUTOR1, NUM_PAGINAS1);
		LibroEscrito libro2 = new LibroEscrito(libro1);
	...
	public void equalsHashCodeComparaCorrectamente() {
		LibroEscrito otroLibro = new LibroEscrito(TITULO1, AUTOR1, NUM_PAGINAS2);
		...
		otroLibro = new LibroEscrito(TITULO1, AUTOR2, NUM_PAGINAS2);
